...
public class ClusterStarsAnalysisConcreteFeatures {
	...
	public static void main(String[] args) {
		...
		String[] features = { "ADD-EAnnotation", "ADD-EAttribute", "ADD-EClass", "ADD-EDataType", "ADD-EEnum", "ADD-EEnumLiteral", "ADD-EGenericType",
				...
				"ADD-ResourceAttachment.EAnnotation", "ADD-ResourceAttachment.EDataType", "ADD-ResourceAttachment.EPackage",
				"CHANGE-EAnnotation.references", "CHANGE-EAnnotation.source", "CHANGE-EAttribute.changeable", "CHANGE-EAttribute.defaultValueLiteral",
				"CHANGE-EAttribute.derived", "CHANGE-EAttribute.eGenericType", "CHANGE-EAttribute.eType", "CHANGE-EAttribute.iD",
				...
				"CHANGE-EClass.abstract", "CHANGE-EClass.eGenericSuperTypes", "CHANGE-EClass.eSuperTypes", "CHANGE-EClass.eTypeParameters",
				"CHANGE-EClass.instanceClassName", "CHANGE-EClass.instanceTypeName", "CHANGE-EClass.interface", "CHANGE-EClass.name",
				"CHANGE-EDataType.eTypeParameters", "CHANGE-EDataType.instanceClassName", "CHANGE-EDataType.instanceTypeName",
				...
				"CHANGE-EGenericType.eClassifier", "CHANGE-EGenericType.eTypeParameter", "CHANGE-EOperation.eExceptions",
				"CHANGE-EOperation.eGenericType", "CHANGE-EOperation.eType", "CHANGE-EOperation.eTypeParameters", "CHANGE-EOperation.lowerBound",
				"CHANGE-EOperation.name", "CHANGE-EOperation.ordered", "CHANGE-EOperation.unique", "CHANGE-EOperation.upperBound",
				"CHANGE-EPackage.name", "CHANGE-EPackage.nsPrefix", "CHANGE-EPackage.nsURI", "CHANGE-EParameter.eGenericType",
				...
				"CHANGE-EReference.defaultValueLiteral", "CHANGE-EReference.derived", "CHANGE-EReference.eGenericType", "CHANGE-EReference.eKeys",
				"CHANGE-EReference.eOpposite", "CHANGE-EReference.eType", "CHANGE-EReference.lowerBound", "CHANGE-EReference.name",
				"CHANGE-EReference.ordered", "CHANGE-EReference.resolveProxies", "CHANGE-EReference.transient", "CHANGE-EReference.unique",
				"CHANGE-EReference.unsettable", "CHANGE-EReference.upperBound", "CHANGE-EReference.volatile", "CHANGE-EStringToStringMapEntry.key",
				...
				"DELETE-EReference", "DELETE-EStringToStringMapEntry", "DELETE-ResourceAttachment.EPackage", "MOVE-EAttribute", "MOVE-EClass",
				"MOVE-EDataType", "MOVE-EEnum", "MOVE-EEnumLiteral", "MOVE-EGenericType", "MOVE-EOperation", "MOVE-EPackage", "MOVE-EReference" };
