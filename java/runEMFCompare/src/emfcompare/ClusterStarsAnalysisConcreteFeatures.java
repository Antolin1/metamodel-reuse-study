...
public class ClusterStarsAnalysisConcreteFeatures {
	...
	public static void main(String[] args) {
		...
		String[] features = { "ADD-EAnnotation", "ADD-EAttribute", "ADD-EClass", "ADD-EDataType", "ADD-EEnum", "ADD-EEnumLiteral", "ADD-EGenericType",
				...
				"ADD-ETypeParameter", "ADD-ResourceAttachment.EAnnotation", "ADD-ResourceAttachment.EDataType", "ADD-ResourceAttachment.EPackage",
				...
				"CHANGE-EAttribute.derived", "CHANGE-EAttribute.eType", "CHANGE-EAttribute.iD", "CHANGE-EAttribute.lowerBound",
				"CHANGE-EAttribute.name", "CHANGE-EAttribute.ordered", "CHANGE-EAttribute.transient", "CHANGE-EAttribute.unique",
				"CHANGE-EAttribute.unsettable", "CHANGE-EAttribute.upperBound", "CHANGE-EAttribute.volatile", "CHANGE-EClass.abstract",
				"CHANGE-EClass.eSuperTypes", "CHANGE-EClass.instanceClassName", "CHANGE-EClass.instanceTypeName", "CHANGE-EClass.interface",
				"CHANGE-EClass.name", "CHANGE-EDataType.instanceClassName", "CHANGE-EDataType.instanceTypeName", "CHANGE-EDataType.name",
				"CHANGE-EDataType.serializable", "CHANGE-EEnum.instanceClassName", "CHANGE-EEnum.instanceTypeName", "CHANGE-EEnum.name",
				"CHANGE-EEnumLiteral.literal", "CHANGE-EEnumLiteral.name", "CHANGE-EEnumLiteral.value", "CHANGE-EGenericType.eClassifier",
				"CHANGE-EGenericType.eTypeParameter", "CHANGE-EOperation.eExceptions", "CHANGE-EOperation.eType", "CHANGE-EOperation.lowerBound",
				"CHANGE-EOperation.name", "CHANGE-EOperation.ordered", "CHANGE-EOperation.unique", "CHANGE-EOperation.upperBound",
				"CHANGE-EPackage.name", "CHANGE-EPackage.nsPrefix", "CHANGE-EPackage.nsURI", "CHANGE-EParameter.eType",
				"CHANGE-EParameter.lowerBound", "CHANGE-EParameter.name", "CHANGE-EParameter.ordered", "CHANGE-EParameter.unique",
				"CHANGE-EParameter.upperBound", "CHANGE-EReference.changeable", "CHANGE-EReference.containment",
