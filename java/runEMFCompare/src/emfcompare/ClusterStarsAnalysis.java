...
public class ClusterStarsAnalysis {
	...
	public static void main(String[] args) {
		...
		String[] features = { "ADD-EAnnotation.contents", "ADD-EAnnotation.details", "ADD-EAnnotation.references", "ADD-EClass.eGenericSuperTypes",
				...
				"ADD-EReference.eKeys", "ADD-ETypeParameter.eBounds", "ADD-ETypedElement.eGenericType", "CHANGE-EAnnotation.source",
				"CHANGE-EAttribute.iD", "CHANGE-EClass.abstract", "CHANGE-EClass.interface", "CHANGE-EClassifier.instanceClassName",
				"CHANGE-EClassifier.instanceTypeName", "CHANGE-EDataType.serializable", "CHANGE-EEnumLiteral.literal", "CHANGE-EEnumLiteral.value",
				"CHANGE-ENamedElement.name", "CHANGE-EPackage.nsPrefix", "CHANGE-EPackage.nsURI", "CHANGE-EReference.containment",
				"CHANGE-EReference.resolveProxies", "CHANGE-EStringToStringMapEntry.key", "CHANGE-EStringToStringMapEntry.value",
				"CHANGE-EStructuralFeature.changeable", "CHANGE-EStructuralFeature.defaultValueLiteral", "CHANGE-EStructuralFeature.derived",
				"CHANGE-EStructuralFeature.transient", "CHANGE-EStructuralFeature.unsettable", "CHANGE-EStructuralFeature.volatile",
				"CHANGE-ETypedElement.eType", "CHANGE-ETypedElement.lowerBound", "CHANGE-ETypedElement.ordered", "CHANGE-ETypedElement.unique",
				"CHANGE-ETypedElement.upperBound", "DELETE-EAnnotation.contents", "DELETE-EAnnotation.details", "DELETE-EAnnotation.references",
				"DELETE-EClass.eGenericSuperTypes", "DELETE-EClass.eOperations", "DELETE-EClass.eStructuralFeatures", "DELETE-EClass.eSuperTypes",
				"DELETE-EClassifier.eTypeParameters", "DELETE-EEnum.eLiterals", "DELETE-EGenericType.eLowerBound",
				"DELETE-EGenericType.eTypeArguments", "DELETE-EGenericType.eUpperBound", "DELETE-EModelElement.eAnnotations",
				"DELETE-EOperation.eExceptions", "DELETE-EOperation.eParameters", "DELETE-EOperation.eTypeParameters", "DELETE-EPackage.eClassifiers",
				"DELETE-EPackage.eSubpackages", "DELETE-EReference.eKeys", "DELETE-ETypeParameter.eBounds", "DELETE-ETypedElement.eGenericType",
